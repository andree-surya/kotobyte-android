...
public class KanjiStrokeView extends View {
    ...
    public KanjiStrokeView(Context context, List<String> strokes, int drawLimit) {
        ...
        int mStrokeColor = ContextCompat.getColor(getContext(), R.color.primary_text);
        int mGuideColor = ContextCompat.getColor(getContext(), R.color.divider);
        int mMarkColor = ContextCompat.getColor(getContext(), R.color.primary);
